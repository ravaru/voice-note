...
**Почему не запускается backend?**  
Приложение запускает backend автоматически. Если зависло на «Запуск бэкенда…», перезапустите приложение.  
Если не помогает — проверьте, что Python 3.11+ и зависимости backend установлены.

**Где лежат результаты?**  
`backend/out/<job_id>/` — все артефакты обработки (mp3, wav, transcript, summary).
